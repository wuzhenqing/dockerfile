...
Swap in `cann/master/openeuler22.03/Dockerfile` for the openEuler variant.
...
[`cann-master-weekly.yml`](../../.github/workflows/cann-master-weekly.yml) rebuilds both variants every Tuesday against the latest CANN master snapshot and publishes rolling multi-arch tags such as `cann:master-910b-ubuntu22.04`.
